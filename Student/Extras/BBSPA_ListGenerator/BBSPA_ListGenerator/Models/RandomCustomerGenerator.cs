...
namespace BBSPA_ListGenerator {
  ...
  class RandomCustomerGenerator {
    ...
    private static string[] CompanyNames = new string[] {
        ...
        "Krusty Burger", "Kwik-E-Mart", "Liandri Mining Corporation", "LuthorCorp", "Medical Mechanica", "Mel's Diner", "Metacortex", "Dunder Mifflin Paper Company", "Milliways", "Mishima ZaibatsuRAMJAC Corporation", "Muffin Buffalo", "Nordyne Defense Dynamics", "North Western Railway", "Oceanic Airlines", "Office of Scientific Intelligence7", "Onion Pacific Railroad",
